...
class Sidebar extends StatelessWidget {
        ...
        children: [
          ...
          Expanded(
            child: SingleChildScrollView(
              ...
              child: Column(
                children: [
                  _buildMenuItem(context, 0, Icons.dashboard, 'Tableau de bord'),
                  ...
                  if ((currentRole ?? '') == 'admin' || (currentPermissions?.contains('view_users') ?? false))
                    _buildMenuItem(context, 6, Icons.admin_panel_settings, 'Utilisateurs'),
                  _buildMenuItem(context, 7, Icons.calendar_today, 'Emplois du Temps'),
                  ...
                  Padding(
                    ...
                    child: Divider(color: Colors.white.withOpacity(0.5), thickness: 1.6),
                  ),
                  ...
                  Padding(
                    ...
                    child: Tooltip(
                      ...
                      onPressed: () async {
                        ...
                        final confirmed = await showDialog<bool>(
                          ...
                          builder: (ctx) => AlertDialog(
                            backgroundColor: theme.cardColor, // Use captured theme's card color
                      ...
                      style: ElevatedButton.styleFrom(
                        backgroundColor: const Color(0xFFE11D48), // red accent for danger
                        foregroundColor: Colors.white,
                        elevation: 2,
                        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12)),
                      ),
  ...
  Widget _buildMenuItem(BuildContext context, int index, IconData icon, String title) {
    ...
    final bool isAllowed = allowedIndices == null || allowedIndices!.contains(index);
    return Padding(
      ...
      child: AnimatedContainer(
        ...
        child: ListTile(
          leading: Icon(
            icon,
            color: isAllowed ? (isSelected ? Colors.white : Colors.white70) : Colors.white24,
            size: 28,
          ),
          title: Text(
            title,
          ...
          onTap: () {
            if (!isAllowed) {
              ...
              showRootSnackBar(const SnackBar(content: Text('Accès refusé pour cet écran')));
              return;
            }
