...
class PdfService {
                      ...
                      children: [
                        ...
                        pw.Column(
                          ...
                          children: [
                            ...
                            pw.SizedBox(height: 4),
                            pw.Text(
                              'Reçu N°: ${currentPayment.id ?? currentPayment.date.hashCode}',
  ...
  static Future<File> savePaymentReceiptPdf({
    ...
    final file = File(
      '${directory.path}/recu_paiement_${student.id}_${currentPayment.id ?? DateTime.now().millisecondsSinceEpoch}.pdf',
    );
                ...
                children: [
                  ...
                  pw.Row(
                    children: [
                      ...
                      pw.Expanded(
                        child: pw.Text(
                          'Statut : ${student.status.isNotEmpty ? student.status : '-'}',
                          style: pw.TextStyle(
                            font: timesBold,
                            color: mainColor,
                          ),
              ...
              pw.Widget buildTableForSubjects(
                ...
                for (final subject in names) {
                  ...
                  final compoNote = compositions.isNotEmpty
                      ? compositions.first.value.toStringAsFixed(2)
                      : '-';
                  final compoSur = compositions.isNotEmpty
                      ? compositions.first.maxValue.toStringAsFixed(2)
                      : '-';
                  double total = 0;
                  double totalCoeff = 0;
                  ...
                  pw.Expanded(
                    ...
                    child: pw.Column(
                      ...
                      children: [
                        ...
                        pw.SizedBox(height: 4),
                        pw.Text(
                          'Conduite: ' + (conduite.isNotEmpty ? conduite : '-'),
                          style: pw.TextStyle(
                            color: secondaryColor,
                            fontSize: smallFont,
                          ),
